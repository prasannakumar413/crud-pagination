...
public class ProjectController {
	...
	@GetMapping("/bookingDetails/{bookingId}/{city}")
	public List<ProjectEntity>IdandCity(@PathVariable("bookingId") int bookingId,@PathVariable("city") String city)
	{
		return stuService.getIdBy(bookingId, city);
	}
